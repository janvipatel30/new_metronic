...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('public/backend/assets/pages/css/login-4.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <script src="{{ asset('public/backend/assets/global/plugins/backstretch/jquery.backstretch.min.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{ asset('public/backend/assets/global/scripts/app.min.js') }}" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{ asset('public/backend/assets/pages/scripts/login-4.min.js') }}" type="text/javascript"></script>
